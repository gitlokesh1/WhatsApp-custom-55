...
The build refuses to start without a valid HTTPS origin. Release signing credentials must remain outside the repository. Users see the recipient, full message, selected SIM, multipart count, reward, and carrier-charge warning before every send.
